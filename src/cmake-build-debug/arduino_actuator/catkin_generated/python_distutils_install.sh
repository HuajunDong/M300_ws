...
echo_and_run cd "/home/huajun/M300_ws/src/arduino_actuator"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/huajun/M300_ws/src/arduino_actuator/setup.py" \
     \
    build --build-base "/home/huajun/M300_ws/src/cmake-build-debug/arduino_actuator" \
    install \
    --root="${DESTDIR-/}" \
