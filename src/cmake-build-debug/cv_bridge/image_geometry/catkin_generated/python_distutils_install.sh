...
echo_and_run cd "/home/huajun/M300_ws/src/cv_bridge/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/huajun/M300_ws/src/cv_bridge/image_geometry/setup.py" \
     \
    build --build-base "/home/huajun/M300_ws/src/cmake-build-debug/cv_bridge/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
